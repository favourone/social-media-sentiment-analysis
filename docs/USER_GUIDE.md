...
本文档适用于“舆情雷达 V2：公共事件态势可视化平台”的本地使用、竞赛演示和基础运维。项目面向非商业教学、个人研究和数据可视化竞赛场景。
...
- 旧版分析大屏：<http://127.0.0.1:5000/dashboard>
...
10. 进入“报告”，生成 PDF 或 CSV。

离线演示数据具有以下特点：

- 固定 54 条合成记录，不伪装成真实采集数据；
- 稳定聚合为校园餐饮、信息服务、财务提醒 3 条事件线；
...
source-001,某公共事件现场情况受到关注,用户甲,2026-08-06 09:30:00,120,35,18,https://example.com/post/001,import
source-002,相关部门已经发布情况通报,用户乙,2026-08-06 10:15:00,86,21,12,https://example.com/post/002,import
```
